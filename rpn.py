...
def calc_rpn(C, img_data, width, height,
                ...
                for jy in range(output_height):
                    ...
                    for bbox_num in range(num_bboxes):
                        ...
                        if curr_iou > best_iou_for_bbox[bbox_num] or curr_iou > C.rpn_max_overlap:
                            ...
                            # cxa, cya are the center point of anchor bbox
                        ...
                        if img_data['bboxes'][bbox_num]['class'] != 'bg':
                            ...
                            if curr_iou > best_iou_for_bbox[bbox_num]:
                                # anchor position jy->height, ix->width, ...
                                best_anchor_for_bbox[bbox_num] = [jy, ix, anchor_ratio_idx, anchor_size_idx]
                                best_iou_for_bbox[bbox_num] = curr_iou
                                # actual anchor x, y co-ordinates
...
def rpn_layer(base_layers, num_anchors):
    """Create a rpn layer
        ...
        Step2: Pass the step1 to two (1,1) convolutional layer to replace the fully connected layer
                ...
                regression layer: num_anchors*4 (36 in here) channels for computing the regression \
                of bboxes with linear activation
    Args:
...
def get_anchor_gt(all_img_data, C,
                  img_length_calc_function,
                  mode='train'):
    ...
    while True:
        for img_data in all_img_data:
            try:
                ...
                try:
                    y_rpn_cls, y_rpn_regr, num_pos = calc_rpn(C,
                                                              img_data_aug,
                                                              width, height,
                                                              resized_width,
                                                              resized_height,
